...
public class CustomGlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(
        ...
        CustomExceptionResponse exceptionResponse = getResponseErrorDto(
    ...
    private CustomExceptionResponse getResponseErrorDto(LocalDateTime dateTime,
                                                 HttpStatus status, List<String> errors) {
        CustomExceptionResponse exceptionResponse = new CustomExceptionResponse();
        exceptionResponse.setTime(dateTime.toString());
